...
class TestCaseSiaNodeResource:
    ...
    def test_create(self, client, app, sia_node, id_namespace):
        ...
        # Create a new node
        response = client.post(app.url_path_for("sia:sia_node-create"), json=sia_node)
        assert response.status_code == 201, response
        assert response.json() == expected_result, response.json()

        # Check it is created
        response = client.get(app.url_path_for("sia:sia_node-retrieve", element_id=element_id), json=sia_node)
    ...
    def test_retrieve(self, client, app, sia_node, id_namespace):
        ...
        # Check it is created
        response = client.get(app.url_path_for("sia:sia_node-retrieve", element_id=element_id))
        assert response.status_code == 200, response
        assert response.json() == expected_result, response.json()
    ...
    def test_update(self, client, app, sia_node, id_namespace):
        ...
        # Update this node
        response = client.put(app.url_path_for("sia:sia_node-update", element_id=element_id), json=update_node)
        assert response.status_code == 200, response
        assert response.json() == expected_result, response.json()
    ...
    def test_delete(self, client, app, sia_node, id_namespace):
        ...
        # Delete this node
        response = client.delete(app.url_path_for("sia:sia_node-delete", element_id=element_id))
    ...
    def test_list(self, client, app, sia_node, id_namespace):
        ...
        # Create a new node
        response = client.post(app.url_path_for("sia:sia_node-create"), json=sia_node_1)
        assert response.status_code == 201, response
        assert response.json() == expected_node_1, response.json()

        # Create a new node
        response = client.post(app.url_path_for("sia:sia_node-create"), json=sia_node_2)
        assert response.status_code == 201, response
        assert response.json() == expected_node_2, response.json()

        # List all nodes
        response = client.get(app.url_path_for("sia:sia_node-list"))
        assert response.status_code == 200, response
    ...
    def test_drop(self, client, app, sia_node, id_namespace):
        ...
        # Drop collection
        response = client.delete(app.url_path_for("sia:sia_node-drop"))
        assert response.status_code == 204, response
